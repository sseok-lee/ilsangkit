    ...
    <div class="flex flex-col gap-3">
      ...
      <template v-if="facility.category === 'toilet' && (details?.facilityType || details?.openTime || details?.managingOrg || details?.installDate || details?.ownershipType)">
        ...
        <div v-if="details?.managingOrg || details?.installDate || details?.ownershipType" class="mt-1 pt-3 border-t border-slate-100">
          ...
          <div class="flex flex-col gap-2">
            <div class="flex items-center justify-between">
              <span class="text-xs text-slate-500">관리기관</span>
            ...
            <div class="flex items-center justify-between">
              <span class="text-xs text-slate-500">설치일</span>
              <span v-if="details?.installDate" class="text-xs text-slate-500">{{ details?.installDate }}</span>
              <span v-else class="text-xs text-slate-500">{{ EMPTY_FIELD_TEXT }}</span>
            </div>
            <div class="flex items-center justify-between">
              <span class="text-xs text-slate-500">소유구분</span>
      ...
      <template v-if="facility.category === 'wifi' && (details?.managementAgency || details?.serviceProvider || details?.installDate)">
        <div class="mt-1 pt-3 border-t border-slate-100">
          ...
          <div class="flex flex-col gap-2">
            ...
            <div class="flex items-center justify-between">
              <span class="text-xs text-slate-500">서비스 제공사</span>
      ...
      <template v-if="facility.category === 'clothes' && (details?.detailLocation || details?.providerName || details?.managementAgency)">
        ...
        <div v-if="details?.providerName || details?.managementAgency" class="mt-1 pt-3 border-t border-slate-100">
          ...
          <div class="flex flex-col gap-2">
            <div class="flex items-center justify-between">
              <span class="text-xs text-slate-500">운영기관</span>
      ...
      <template v-if="facility.category === 'park' && ((details as any)?.parkType || (details as any)?.designatedDate || (details as any)?.managingOrg)">
        ...
        <div v-if="(details as any)?.designatedDate || (details as any)?.managingOrg" class="mt-1 pt-3 border-t border-slate-100">
          ...
          <div class="flex flex-col gap-2">
            <div class="flex items-center justify-between">
              <span class="text-xs text-slate-500">지정일</span>
      ...
      <template v-if="facility.category === 'library'">
        <template v-if="details?.libraryType || details?.closedDays">
          <div class="h-px bg-slate-100 w-full"></div>
          <div class="flex flex-col gap-3">
            <div class="flex items-center justify-between">
      ...
      <template v-if="facility.category === 'aed'">
        ...
        <template v-if="details?.org">
          <div class="mt-1 pt-3 border-t border-slate-100">
            ...
            <div class="flex flex-col gap-2">
              <div class="flex items-center justify-between">
                <span class="text-xs text-slate-500">설치기관</span>
                <span class="text-xs text-slate-500">{{ String(details?.org || '').replace(/^[\s-]+|[\s-]+$/g, '') }}</span>
              </div>
            </div>
          </div>
        </template>
      ...
      <template v-if="facility.category === 'hospital'">
        ...
        <template v-if="details?.foundationCdNm || details?.estbDd">
          <div class="mt-1 pt-3 border-t border-slate-100">
            <p class="text-xs font-medium text-slate-500 mb-2">기타 정보</p>
            <div class="flex flex-col gap-2">
              <div class="flex items-center justify-between">
                <span class="text-xs text-slate-500">설립구분</span>
                <span v-if="details?.foundationCdNm" class="text-xs text-slate-500">{{ details.foundationCdNm }}</span>
                <span v-else class="text-xs text-slate-500">{{ EMPTY_FIELD_TEXT }}</span>
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-slate-500">개설일자</span>
      ...
      <template v-if="facility.category === 'market'">
        ...
        <template v-if="(details as any)?.foundedYear != null">
          <div class="mt-1 pt-3 border-t border-slate-100">
            ...
            <div class="flex flex-col gap-2">
              <div class="flex items-center justify-between">
                <span class="text-xs text-slate-500">개설연도</span>
                <span class="text-xs text-slate-500">{{ (details as any).foundedYear }}년</span>
              </div>
            </div>
          </div>
        </template>
      ...
      <template v-if="facility.category === 'childcare'">
        ...
        <template v-if="(details as any)?.crhome">
          <div class="h-px bg-slate-100 w-full"></div>
          <div class="flex items-center justify-between">
            <span class="text-sm text-gray-600">홈페이지</span>
        ...
        <template v-if="(details as any)?.crcnfmdt || (details as any)?.crrepname || (details as any)?.crfaxno || (details as any)?.crcargbname || ((details as any)?.crpausebegindt && (details as any)?.crpauseenddt) || (details as any)?.crspec || (details as any)?.datastdrdt || (details as any)?.crstatusname === '폐지'">
          <div class="mt-1 pt-3 border-t border-slate-100">
            ...
            <div v-if="(details as any)?.crspec" class="mt-2">
      ...
      <template v-if="facility.category === 'sports'">
        ...
        <template v-if="(details as any)?.fcobNm">
          <div class="mt-1 pt-3 border-t border-slate-100">
            ...
            <div class="flex flex-col gap-2">
              <div class="flex items-center justify-between">
                <span class="text-xs text-slate-500">업종명</span>
                <span class="text-xs text-slate-500">{{ (details as any).fcobNm }}</span>
              </div>
            </div>
          </div>
        </template>
