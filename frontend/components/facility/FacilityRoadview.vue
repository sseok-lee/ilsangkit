<template>
  <ClientOnly>
    <div class="relative w-full h-[200px] md:h-[240px] rounded-xl border border-[#e5e7eb] overflow-hidden bg-gray-100">
      <!-- Loading -->
      ...
      <!-- Unavailable -->
      <div v-else-if="!available" class="absolute inset-0 flex flex-col items-center justify-center bg-gray-100 text-gray-400">
