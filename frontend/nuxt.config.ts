  ...
  app: {
    head: {
      ...
      script: [
        ...
        {
          innerHTML: `(function(){var f=['https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0..1,0&icon_names=accessible,add,apartment,arrow_back,arrow_drop_down,arrow_drop_up,arrow_forward,article,baby_changing_station,bar_chart,business,calendar_month,call,cancel,chat_bubble_outline,check,check_circle,checklist,checkroom,chevron_left,chevron_right,child_care,close,corporate_fare,delete,description,directions,domain,download,eco,edit_note,emergency,error,error_outline,ev_station,event_upcoming,expand_less,expand_more,explore,favorite,first_page,grid_view,groups,health_and_safety,help,holiday_village,home,house,info,key,landscape,last_page,lightbulb,local_hospital,local_library,local_parking,local_fire_department,local_pharmacy,location_city,location_off,location_on,man,meeting_room,menu,menu_book,near_me,notifications_active,open_in_full,open_in_new,park,payments,person,place,play_circle,print,rate_review,recycling,refresh,remove,restaurant,schedule,school,search,search_off,sell,share,sports,stars,storefront,subway,support_agent,trending_up,verified,verified_user,videocam,visibility,visibility_off,warning,wc,weekend,wifi,woman&display=swap','https://cdn.jsdelivr.net/gh/orioncactus/pretendard@v1.3.9/dist/web/variable/pretendardvariable-dynamic-subset.min.css'];f.forEach(function(h){var l=document.createElement('link');l.rel='stylesheet';l.href=h;document.head.appendChild(l)})})()`,
