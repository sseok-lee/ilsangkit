...
const mockGetRegionDetail = vi.fn(async (_params: any) => ({
  ...
  totalPages: 1,
  jimokDistribution: [
    { jimok: '대', count: 100, avgPricePerPyeong: 8000 },
    { jimok: '전', count: 20, avgPricePerPyeong: null },
  ],
  landUseDistribution: [
  ...
  priceTimeline: [
    { year: 2026, month: 5, avgPricePerPyeong: 8200, count: 10 },
    { year: 2026, month: 4, avgPricePerPyeong: 7800, count: 8 },
  ],
  daeCount: 100,
}))
