...
export const NAV_GROUPS: readonly NavGroup[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { to: '/subscription/rent/private', label: '공공지원 민간임대', icon: 'bungalow', iconImg: 'rent', section: '임대 청약' },
      // 공공임대 입주 — 자격 기반 수시 신청 (LH/SH 등)
      { to: '/public-rental', label: '공공임대 단지', icon: 'home', iconImg: 'rent', section: '공공임대 입주' },
      { to: '/public-rental/buy-lease', label: '매입임대', icon: 'apartment', iconImg: 'rent', section: '공공임대 입주' },
      { to: '/public-rental/charter', label: '전세임대', icon: 'key', iconImg: 'rent', section: '공공임대 입주' },
    ],
  },
  ...CATEGORY_GROUPS,
] as const
