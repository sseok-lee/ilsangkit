  ...
  <div class="min-h-screen bg-background-light flex flex-col text-slate-900">
    <main class="flex-1 w-full">
      ...
      <div v-else-if="error || !station" class="max-w-lg mx-auto px-4 py-20 text-center">
        ...
        <NuxtLink to="/subway" class="inline-block mt-4 px-6 py-2 bg-primary text-white rounded-lg hover:bg-primary transition-colors">
          지하철역 목록으로
        </NuxtLink>
      </div>
            ...
            <aside class="hidden md:flex lg:sticky lg:top-24 w-full flex-col">
              ...
              <div class="mt-3 p-4 bg-white border border-slate-200 flex gap-3 shadow-card rounded-xl">
                ...
                <div class="relative flex-[2]">
                  <button
                    class="w-full h-12 rounded-xl bg-primary text-white font-bold text-base hover:bg-primary transition-colors shadow-lg shadow-primary-500/30 flex items-center justify-center gap-2"
