...
export const CATEGORY_SEO_DESCRIPTION: Record<FacilityCategory, string> = {
  hospital:     '전국 병원의 진료과목·진료시간·위치를 지도에서 확인하세요. 내과·정형외과·피부과 등 진료과별 검색과 지역별 목록으로 가까운 병원을 무료로 찾아보세요.',
  pharmacy:     '전국 약국의 영업시간·위치를 지도에서 확인하세요. 시·도와 구·군별 목록에서 약국을 찾고 상세에서 요일별 영업시간과 연락처를 바로 확인해 보세요.',
  parking:      '전국 공영주차장의 요금·운영시간·주차 가능 면수를 지도에서 확인하세요. 무료·유료 구분과 지역별 목록으로 목적지 근처 주차 공간을 쉽게 찾아보세요.',
  toilet:       '전국 공중화장실의 위치·개방시간·남녀 구분 여부를 지도에서 확인하세요. 시·도와 구·군별 목록으로 가려는 지역의 화장실을 빠르게 찾을 수 있습니다.',
  ...
  clothes:      '전국 의류수거함의 위치·배출 가능 품목을 지도에서 확인하세요. 시·도와 구·군별 목록에서 우리 동네 헌 옷 수거함을 찾아 의류를 올바르게 배출하세요.',
