...
describe('CSV Parser - transformParkingRow', () => {
  ...
  it('should build operating hours string correctly', () => {
    const row: ParkingCSVRow = {
      ...
      prkplceSe: '공영',
      prkplceType: '노외',
      rdnmadr: '서울특별시 중구 세종대로 123',
      lnmadr: '',
      prkcmprt: '100',
      operDay: '평일+토요일',
      weekdayOperOpenHhmm: '07:00',
      weekdayOperColseHhmm: '23:00',
      satOperOperOpenHhmm: '08:00',
      satOperCloseHhmm: '20:00',
      parkingchrgeInfo: '유료',
      basicTime: '30',
      basicCharge: '1000',
      addUnitTime: '15',
