...
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  toilet: ['공공화장실', '공중화장실 위생', '화장실 찾기'],
  aed: ['자동심장충격기', 'AED 사용법', '심폐소생술'],
  hospital: ['병원 찾기', '야간진료', '응급실'],
  pharmacy: ['약국 영업시간', '야간약국', '처방전'],
  parking: ['공영주차장', '주차요금', '주차장 찾기'],
  wifi: ['공공와이파이', '무료인터넷', '공공WiFi'],
  kiosk: ['무인민원', '주민등록등본 발급', '민원서류'],
  clothes: ['의류수거함', '헌옷 기부', '의류 재활용'],
  library: ['공공도서관', '도서 대출', '독서'],
  trash: ['쓰레기 분리수거', '재활용', '대형폐기물'],
};
