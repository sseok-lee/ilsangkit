...
## 자주 하는 실수와 해결법
(이용 시 흔히 하는 실수 5가지 이상. 반드시 아래 형식을 따를 것:
...
⚠️ 형식 규칙: 제목, "이런 실수를 해요:", "이렇게 해결하세요:" 각각 별도 줄에 작성. 한 줄에 이어쓰기 금지. 반드시 5개 이상)
...
## 자주 하는 실수와 해결법
(거래 시 흔한 실수 5가지 이상. 반드시 아래 형식을 따를 것:
...
## 주의사항과 흔한 실수
(이 과정에서 자주 하는 실수 5가지 이상. 반드시 아래 형식을 따를 것:
...
⚠️ 형식 규칙: 제목, "이런 실수를 해요:", "이렇게 해결하세요:" 각각 별도 줄에 작성. 한 줄에 이어쓰기 금지. 반드시 3개 이상)
